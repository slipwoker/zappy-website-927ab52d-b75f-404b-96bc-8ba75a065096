  ...
  document.body.addEventListener('submit', function (e) {
    ...
    fields.forEach(function (field) {
      ...
      if (field.hasAttribute('required') && value === '') {
        errorMsg = getFieldLabel(field) + ' is required.';
      } else if (value !== '') {
        if (field.type === 'email' && !isValidEmail(value)) {
          ...
          errorMsg = getFieldLabel(field) + ' must be at least ' + field.minLength + ' characters.';
        } else if (field.maxLength && field.maxLength > 0 && value.length > field.maxLength) {
          errorMsg = getFieldLabel(field) + ' must not exceed ' + field.maxLength + ' characters.';
        }
      }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "סינמה אנלימיטד משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '927ab52d-b75f-404b-96bc-8ba75a065096',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '927ab52d-b75f-404b-96bc-8ba75a065096';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '927ab52d-b75f-404b-96bc-8ba75a065096';
